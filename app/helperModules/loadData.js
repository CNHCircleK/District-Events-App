...
function loadActivities()
{
    ...
    const actPromise = colActivities.get().then(query => {
...
function loadWorkshops()
{
    ...
    const wsPromise = colWorkshops.get().then(query => {
...
function loadCaucuses()
{
    ...
    const cauPromise = colCaucuses.get().then(query => {
